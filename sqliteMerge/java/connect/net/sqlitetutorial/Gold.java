        ...
        while(true) {
            ...
            switch(promptRes) {
                ...
                case 3: {
                    ...
                    List<Course> output = listCoursesEnrolledQuarter(year_and_quarter);
                    for(int i = 0; i < output.size(); i++) {
                        System.out.println(output.get(i).course_number + ": " + output.get(i).title);
                    }
                    break;
                }
                case 4: {
                    String year_and_quarter = promptForString(sc,"Year and Quarter");
                    List<String> grades = listGradesEnrolledQuarter(year_and_quarter);
    ...
    public List<String> listGradesEnrolledQuarter(String year_and_quarter) {
        ...
        for(int i = 0; i < enrollments.size(); i++) {
            ...
            if(offering.year_and_quarter.equals(year_and_quarter)) {
                grades.add(offering.course_number + " - " + enrollments.get(i).grade);
            }
        }
        return grades;
    }
